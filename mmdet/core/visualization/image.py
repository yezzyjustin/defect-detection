...
def imshow_det_bboxes(img,
    ...
    bbox_color3 = color_val_matplotlib('green')
    bbox_color4 = color_val_matplotlib('purple')
    bbox_color5 = color_val_matplotlib('cyan')
    bbox_color6 = color_val_matplotlib('yellow')

    text_color = color_val_matplotlib('black')
    ...
    # remove white edges by set subplot margin
    plt.subplots_adjust(left=0, right=1, bottom=0, top=1)
    # plt.subplots_adjust(left=0, right=0.1, bottom=0, top=0.1)
    ax = plt.gca()
    ax.axis('off')
    # ax.axis('equal')
    ...
    for i, (bbox, label) in enumerate(zip(bboxes, labels)):
        ...
        if 'AC' in label_text:
            poly = [[bbox_int[0], bbox_int[1]], [bbox_int[0], bbox_int[3]],
                    [bbox_int[2], bbox_int[3]], [bbox_int[2], bbox_int[1]]]
            np_poly = np.array(poly).reshape((4, 2))
            polygonsC.append(Polygon(np_poly))

            color3.append(bbox_color3)
        ...
        if 'OC' in label_text:
            poly = [[bbox_int[0], bbox_int[1]], [bbox_int[0], bbox_int[3]],
                    [bbox_int[2], bbox_int[3]], [bbox_int[2], bbox_int[1]]]
            np_poly = np.array(poly).reshape((4, 2))
            polygonsD.append(Polygon(np_poly))

            color4.append(bbox_color4)
        ...
        if 'RP' in label_text:
            poly = [[bbox_int[0], bbox_int[1]], [bbox_int[0], bbox_int[3]],
                    [bbox_int[2], bbox_int[3]], [bbox_int[2], bbox_int[1]]]
            np_poly = np.array(poly).reshape((4, 2))
            polygonsE.append(Polygon(np_poly))

            color5.append(bbox_color5)
        ...
        elif 'PT' in label_text:
            poly = [[bbox_int[0], bbox_int[1]], [bbox_int[0], bbox_int[3]],
                    [bbox_int[2], bbox_int[3]], [bbox_int[2], bbox_int[1]]]
            np_poly = np.array(poly).reshape((4, 2))
            polygonsF.append(Polygon(np_poly))

            color6.append(bbox_color6)
    ...
    pC = PatchCollection(
        polygonsC, facecolor='none', edgecolors=color3, linewidths=thickness)
    pD = PatchCollection(
        polygonsD, facecolor='none', edgecolors=color4, linewidths=thickness)
    pE = PatchCollection(
        polygonsE, facecolor='none', edgecolors=color5, linewidths=thickness)
    pF = PatchCollection(
        polygonsF, facecolor='none', edgecolors=color6, linewidths=thickness)
